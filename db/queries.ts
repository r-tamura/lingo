...
export const getCourseProgress = cache(async () => {
	...
	const firstUncompoletedLesson = unitsInActiveCourse
	...
	return {
		activeLesson: firstUncompoletedLesson,
		activeLessonId: firstUncompoletedLesson?.id,
	};
});
